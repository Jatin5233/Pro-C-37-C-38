...
function setup() {
  ...
  sky=createSprite(200,200,400,10);
  sky.addImage(sky_1);
  sky.scale=2.7;
  sky.velocityX=0;
  cK=createSprite(250,200);
  cK.addImage(cK_1);
  cK.scale=0.4;
  start=createSprite(260,280);
...
if(mousePressedOver(start)){
 ...
 if(gs==="PLAY"){
  ...
  carry.velocityY=carry.velocityY+0.8;
  if(frameCount%80===0){
    SpawnTiktok();
...
function SpawnTiktok(){
  var tiktok=createSprite(700,200,10,10);
...
var youtube=createSprite(700,random(50,100),10,10);
youtube.addImage(y1);
